...
import Requests.CommonRequests
...
def define_routes(app, devflk, socketio, app_name, jira_obj, crucible_obj, sql_object):
	'''
	'''

	Routes.JiraRoutes.define_routes(app=app, app_name=app_name, jira_obj=jira_obj, g=g)
	...
	Routes.ChatRoutes.define_routes(app=app, app_name=app_name, sql_object=sql_object, g=g)
