all_open_tickets = 'project in (SASHA, AQE, "Auto QM", "Customer DB", "Manager DB", "Taskmaster Dashboard", TeamDB, TQI, "Unified Desktop", UPM, WAM) AND (status in ("ON HOLD", "IN DEVELOPMENT", "IN SPRINT", "Ready for Release", "Code Review", "Ready For QA", "IN QA", "IN UCT", "READY FOR UCT") OR assignee in (wc591w) OR (labels = beta AND status != closed))'
...
cron_fields='customfield_10212,comment,status,summary,assignee,components,timeoriginalestimate,fixVersions,labels,customfield_10138,epic_link'
